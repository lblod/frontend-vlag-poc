...
function SwitchCases(op, bootstrap, callback) {
  ...
  for (var _iterator = _createForOfIteratorHelperLoose(clauses.slice(0, -1)), _step; !(_step = _iterator()).done;) {
    ...
    op(67
    /* JumpEq */
    , (0, _operands.labelOperand)(_clause.label), _clause.match);
