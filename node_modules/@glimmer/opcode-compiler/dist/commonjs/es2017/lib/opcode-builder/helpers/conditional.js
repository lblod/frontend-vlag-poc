...
exports.SwitchCases = SwitchCases;
exports.Replayable = Replayable;
exports.ReplayableIf = ReplayableIf;
...
function SwitchCases(op, bootstrap, callback) {
  ...
  for (let clause of clauses.slice(0, -1)) {
    op(67
    /* JumpEq */
    , (0, _operands.labelOperand)(clause.label), clause.match);
...
function Replayable(op, args, body) {
  ...
  op(6
  /* ReturnTo */
  , (0, _operands.labelOperand)('ENDINITIAL')); // Push the arguments onto the stack. The args() function
...
function ReplayableIf(op, args, ifTrue, ifFalse) {
  return Replayable(op, args, () => {
    ...
    op(66
    /* JumpUnless */
    , (0, _operands.labelOperand)('ELSE')); // Otherwise, execute the code associated with the true branch.
