  ...
  */
  {
    ...
    "moduleName": "/home/andreo/inuits/abb/VLAG/frontend-poc-app/@ember/test-helpers/setup-rendering-context.js",
    "isStrictMode": false
  });
...
define("ember-data/test-support/index", ["exports", "@ember/debug", "@ember/test-helpers", "qunit", "@embroider/macros/runtime"], function (_exports, _debug, _testHelpers, QUnit, _runtime) {
  ...
  */
  async function render(template) {
    ...
    if ((0, _runtime.macroCondition)((0, _runtime.config)("/home/andreo/inuits/abb/VLAG/frontend-poc-app/node_modules/ember-data").env.PRODUCTION)) {
